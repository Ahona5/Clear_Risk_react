          ...
          <div style={styles.section}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              {linkedControls.map(c => (
                <div key={c.id} style={{ padding: "12px 16px", borderRadius: "8px", border: "1px solid #f1f5f9", background: "#f8fafc", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                   <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                      <Shield size={16} color="#10b981" />
                      <span style={{ fontSize: "14px", fontWeight: 600, color: "#1e293b" }}>{c.name}</span>
                   </div>
                   <span style={{ fontSize: "11px", fontWeight: 700, color: "#94a3b8", textTransform: "uppercase" }}>{c.type}</span>
                </div>
              ))}
